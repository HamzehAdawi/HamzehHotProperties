## Hot Properties
Hot properties is a full stack web app centered around purchase and sale of real estate property. Features include browsing, listing, and inquiring (messaging system) and many more. Deployed on AWS with a DB persistence through MySQL. 
